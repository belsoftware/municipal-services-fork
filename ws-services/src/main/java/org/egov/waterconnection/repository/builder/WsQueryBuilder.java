...
//	private static final String Offset_Limit_String = "OFFSET ? LIMIT ?";
	...
	private static final String WATER_SEARCH_QUERY = "SELECT conn.*, wc.*, document.*, plumber.*,taxhead.*,roadtype.*, wc.connectionCategory, wc.connectionType, wc.waterSource,"
			...
			+ " conn.id as conn_id, conn.tenantid, conn.applicationNo, conn.applicationStatus, conn.status, conn.connectionNo, conn.oldConnectionNo, conn.property_id, conn.roadcuttingarea, conn.usagecategory, conn.subusagecategory,conn.proposedusagecategory, conn.proposedsubusagecategory,"
