...
public class WCConstants {
	...
	public static final String SUBMIT_APPLICATION_PENDING_FOR_FIELD_INSPECTION = "SUBMIT_APPLICATION_PENDING_FOR_FIELD_INSPECTION";
	...
	public static final List<String> NOTIFICATION_ENABLE_FOR_STATUS = Collections
			.unmodifiableList(Arrays.asList(INITIATE_INITIATED, REJECT_REJECTED,
					...
					SUBMIT_APPLICATION_STATUS_CODE, APPROVE_CONNECTION_STATUS_CODE,SUBMIT_APPLICATION_PENDING_FOR_FIELD_INSPECTION));
