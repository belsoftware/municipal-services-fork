...
import org.egov.lams.web.models.workflow.BusinessServiceResponse;
import org.egov.lams.web.models.workflow.State;
...
public class WorkflowService {
    ...
    @Autowired
    public WorkflowService(LamsConfiguration config, ServiceRequestRepository serviceRequestRepository, ObjectMapper mapper) {
        this.config = config;
